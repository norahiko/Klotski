...
declare module chai {
    export interface Assert {
        ...
        equal<T>(act:T, exp:T, msg?:string);
        notEqual<T>(act:T, exp:T, msg?:string);

        strictEqual<T>(act:T, exp:T, msg?:string);
        notStrictEqual<T>(act:T, exp:T, msg?:string);

        deepEqual<T>(act:T, exp:T, msg?:string);
        notDeepEqual<T>(act:T, exp:T, msg?:string);
